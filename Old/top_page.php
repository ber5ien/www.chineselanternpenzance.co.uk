...
<table border=0 style="width: 1000px;" align=center cellpadding="0" cellspacing="0">
 <tr><td align=center><table style="width: 1000px; background-image:url(graphics/banner.png); height: 157px"><tr><td></td></tr></table></td></tr>
</table> 
<!-- end of top banner -->
				 ...
				 <table border=0 align=center style="width: 950px; margin-left: 20px"  cellpadding="0" cellspacing="0">
					<tr>
						...
						<td width=200 valign=top>	
								...
								<div class="content"><center><h2>CHINESE LANTERN</h2></center></div>
				  					 <div class="subbox">
										<ul>
